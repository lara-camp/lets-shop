<template>
 <AdminLayout>
        <div class="px-4 py-5 md:px-6 lg:px-8" >
            ...
            <Divider/>
            <div class="font-medium text-3xl text-900 mb-4">Edit Coupon</div>
            <!-- Coupon Form Section -->
            <form class="grid justify-content-center" @submit.prevent="couponForm.patch(route('coupons.update',coupon.id))">
...
const {coupon,timelines} = defineProps({coupon:Object,timelines:Array})
const  couponForm=useForm({
    code:coupon.coupon_code,
    discount:coupon.discount,
    min_purchase:coupon.min_purchase,
    selectedTimeline:coupon.discounttimeline
})
</script>
