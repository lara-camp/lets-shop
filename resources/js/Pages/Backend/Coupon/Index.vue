<template>
    <AdminLayout>
         <div class="px-4 py-5 md:px-6 lg:px-8">
            ...
            <Dialog v-model:visible="deleteCouponDialog"
                ...
                <div class="confirmation-content">
                    ...
                    <span v-if="coupon">Are you sure you want to delete <b>{{
                        coupon.coupon_code
                        }}</b>?</span>
                </div>
            <template #footer>
                ...
                <DataTable v-model:filters="filters"
                   ...
                   tableStyle="min-width: 50rem">
                    ...
                    <Column field="min_purchase"
                            ...
                            sortable
                            style="width: 10%"></Column>
                    <Column field="is_used"
                            header="Status"
                            sortable
                            style="width: 10%">
                        <template #body="{data}">
                             <Tag :value="isUsedText(data.is_used)" :severity="getSeverity(data.is_used)" rounded/>
                        </template>
                    </Column>
...
//For Is used status
const isUsedText=(isUsed)=> {
    return isUsed === 1 ? 'Alive' : 'Dead';
}

const getSeverity=(isUsed) =>{
    return isUsed === 1 ? 'success' : 'danger'
}
...
const confirmDeleteCoupon = (prod)=>{
    ...
    console.log(coupon.value.coupon_code)
}
const deleteCoupon= () =>{
    router.delete(route('coupons.destroy',coupon.value.id),{preserveState:true})
